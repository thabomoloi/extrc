...
public class LCExplanation implements Explanation {
  ...
  // sb.append("Ranks ").append(rank.getRankNumber()).append(" to ∞ entail
  // ").append(negation).append("\n\n");
  ...
  // sb.append(String.format("Ranks %d to ∞ entail ",
  // rank.getRankNumber())).append(negation)
  // .append("\n");
  ...
  // }
  // } else {
  // sb.append(String.format("Ranks %d to ∞ do not entail ",
  // rank.getRankNumber())).append(negation)
  // .append("\n");
  ...
  // }
  // if (entailed) {
  // sb.append("\nThe remaining ranks entail the formula
  // ").append(formula).append(".\n");
  // sb.append("Therefore ").append(formula).append(" is entailed by the knowledge
  // base.\n");
  // } else {
  // sb.append("\nThe remaining ranks do not entail the formula
  // ").append(formula).append(".\n");
  // sb.append("Therefore ").append(formula).append(" is not entailed by the
  // knowledge base.\n");
  // }
  // return sb.toString();
  // }
