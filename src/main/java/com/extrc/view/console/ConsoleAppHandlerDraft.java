...
public class ConsoleAppHandlerDraft {
  ...
  public ConsoleAppHandlerDraft(Terminal terminal) {
  ...
  // if (validateQuery(formula)) {
  // this.rationalReasoner = new RationalReasoner(kb);
  // explainReasoner(formula, this.rationalReasoner, "RATIONAL CLOSURE
  // EXPLANATION");
  // }
  // }
  ...
  // if (validateQuery(formula)) {
  // this.lexicalReasoner = new LexicalReasoner(kb);
  // explainReasoner(formula, this.lexicalReasoner, "LEXICOGRAPHIC CLOSURE
  // EXPLANATION");
  // }
  // }
